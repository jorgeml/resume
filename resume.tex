...
\begin{itemize}%
\item In 12 months, was System Integrator Lead for three large projects:
  \begin{itemize}
  ...
  \end{itemize}
\item Worked two years as tool specialist consultant in a managed services project for a Belgian 2G/3G mobile operator:
\begin{itemize}
...
platform.
\item Customized deployment of a Linux distribution. 
...
\cvitemwithcomment{Dutch}{Medium}{}
...
\cvlistitem{Erasmus Student Network Alumnus (Honorary life-time membership) for my contribution during a period of three years in two local sections. Participated and sometimes organized national and international events (workshops, meetings, etc.). Served as Vice-National Representative for Spain.}
