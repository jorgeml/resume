...
%% Copyright 2013-2022 Jorge Martinez Lopez (jorgeml@jorgeml.me).
% !TEX program = xelatex
%
...
\usepackage{fontspec}
\setmainfont[Ligatures=TeX]{Merriweather Sans Light} 
\setsansfont{Merriweather Sans Light}
...
%\social[mastodon]{https://hachyderm.io/@jorgeml}
...
\cventry{2019--present}{Customer Program Manager / Service Delivery Manager}{Cisco}{United Kingdom}{}{
  \begin{itemize}
    \item Support the collaboration and data centre technology platforms of a large global financial institution.
    \item Work with the Solutions Architects, customer success, account team, and the customer on creating and updating strategic technology roadmaps, sales account plan, and customer success plan.
    \item Coordinate the delivery of the strategy, design, lifecycle, release management, and testing management contractual deliverables.
    \item Advise the customer on the best engagement model to achieve their desired outcomes.
    \item Make staffing recommendations to delivery teams. Coach engineers and support their career development.
    \item Lead Monthly Platform Service Reviews, contribute and present in QBRs.
  \end{itemize}
}

\cventry{2013--2018}{High Touch Operations Manager}{Cisco}{United Kingdom}{}{
  \begin{itemize}
    \item Delivered premium high-touch technical support services to multiple platforms for a strategic global service provider, ensuring timely resolution of critical incidents.
    \item Led service improvement initiatives that resulted in hundreds of thousands of dollars in cost savings for both the customer and Cisco, and a higher quality service delivery.
...
\cventry{2009--2012}{Technical Project Manager}{Nokia (former Alcatel-Lucent)}{the Netherlands}{}{Consultant in the Global Customer Delivery team in the Benelux.
  \begin{itemize}
    \item System Integrator Lead / Technical Project Manager for three large projects in the IMS Solution Integration Office for a large Dutch service provider. Led pre-sales support by providing requirements definition and commercial offers.
          %\begin{itemize} 
          ...
          %\end{itemize}
    \item ITIL Processes and OSS Tool specialist consultant in a managed services project for a Belgian mobile operator.
          %\begin{itemize}
...
\cventry{2020--present}{Event Volunteer and Photographer}{Lewisham Family Cycling Library}{}{}{Showcase cargo e-bike to local families as an alternative to a car.}
\cventry{2019--present}{Active Travel Campaigner}{London Cycling Campaign}{Lewisham Cyclists}{}{Engage with local politicians and developers to improve walking and cycling infrastructure.}
\cventry{2004--2007}{Various local and international roles, including Spain's VP}{Erasmus Student Network}{}{}{Advised universities on international exchange programmes and represented the Spanish network at international events (including at the EU parliament).}
{
  %\begin{itemize}
...
\cventry{2021}{Cisco Certified DevNet Associate (lapsed)}{Cisco}{}{}{}
\cventry{2019}{ITIL® 4 Foundation Certificate in IT Service Management}{AXELOS Global Best Practice}{}{}{}
\cventry{2019}{Mental Health First Aid}{Mental Health First Aid (MHFA) England}{}{}{}
...
\cventry{2008}{Master of Telecommunications Engineering}{Universidad Carlos III de Madrid}{Madrid, Spain}{}{Socrates/Erasmus student exchange program at the University of Twente from September 2003 to March 2004.}
...
\cvitemwithcomment{English}{Bilingual proficiency}{}
...
\cvitem{Cycling}{Cycling to work and leisure road cycling.}
%\cvitem{Free software}{Linux hobbyist, I contribute by reporting bugs, participating in mailing lists, etc.}
\cvitem{Photography}{Capturing memories of London and travel destinations to express my creativity.}
...
\cvitem{}{Latest version of this résumé available at \url{https://github.com/jorgeml/resume/blob/main/resume.pdf}.}
