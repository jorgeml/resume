...
\title{Telecommunications Operations Manager}                          % optional, remove / comment the line if not wanted
...
\cventry{2009}{Foundation Certificate in Software Testing (ISTQB)}{BCS Professional Certification}{}{}{}  % arguments 3 to 6 can be left empty
\subsection{Degrees}
